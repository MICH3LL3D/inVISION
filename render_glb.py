...
def load_glb_or_gltf(filename):
    ...
    if isinstance(loaded, trimesh.Trimesh):
        ...
        if not meshes:
            raise ValueError(f"No mesh geometry found in {filename}")
...
def load_model(filename):
    ...
    if ext == ".obj":
        ...
        return load_glb_or_gltf(filename)
    else:
...
# Model Config
# =========================
MODEL_PATH = "magical_help.glb"   # change to your .obj / .glb / .gltf file
...
yaw_sensitivity = 1.5
pitch_sensitivity = 2.75
roll_sensitivity = 1.2
    ...
    while running:
        ...
        if hand_count >= 2:
            ...
            if mode == "rotate":
                ...
                yaw, pitch, roll = rotation_matrix_to_euler(rel_R)
